...
const Sidebar = () => {
  ...
  return (
    <>
      <aside
        className={`fixed top-0 left-0 h-screen w-52 bg-white text-gray-700 shadow-2xl z-30 transform transition-transform duration-300 flex flex-col ${
          isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"
        } md:translate-x-0 md:sticky md:shadow-md webkit-overflow-scrolling-touch`}
        style={{
      ...
      >
        <div className="pt-16 md:pt-0 h-full flex flex-col">
          ...
          <div className="mt-auto">
            <Link
              ...
              className={`flex items-center text-lg py-4 px-6 rounded-md transition ${
                isActive(`/business/${currentBusiness.id}`) ? "bg-gray-100 text-accent" : "hover:bg-gray-100 hover:text-accent"
              }`}
            >
      ...
      <div
        className="md:hidden fixed top-4 left-2 z-50 p-4 cursor-pointer"
